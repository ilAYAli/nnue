    ...
    if args.backend == "pytorch":
        ...
        steps.extend([
            {
                ...
                "command": [
                    ...
                    "--select-thresholds", args.policy_thresholds,
                    "--select-max-bad", str(args.policy_gate_max_val_bad),
                    "--select-min-good", str(args.policy_gate_min_val_good),
                    "--select-min-overrides",
        ...
        steps.append({
            ...
            "command": [
                ...
                "--min-groups", str(args.min_groups),
                "--thresholds",
                ("auto" if args.policy_export_threshold < 0.0
                 else str(args.policy_export_threshold)),
                "--split-seed", str(args.selfplay_seed),
                "--split-val-fraction", str(args.policy_val_fraction),
                "--fail-if-top1-below", str(args.policy_gate_min_top1),
                "--fail-if-bad-above", str(args.policy_gate_max_bad),
