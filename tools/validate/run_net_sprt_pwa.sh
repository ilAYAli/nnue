...
ENGINE="${ENGINE:-$HOME/code/chess/assets/engines/reference}"
INIT="${INIT:-$HOME/code/chess/enyo/net/berserk-d43206fe90e4.nn}"
SPRT="${SPRT:-$HOME/code/chess/sprt/sprt}"
FASTCHESS="${FASTCHESS:-}"
BOOK="${BOOK:-$HOME/code/chess/assets/books/UHO_Lichess_4852_v1.epd}"
GAMES="${GAMES:-4000}"
