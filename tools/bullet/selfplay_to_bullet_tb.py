...
the relabel step for relabel_with_syzygy.py.
"""
...
def convert_shard(
    ...
    run([
        str(VENV_PYTHON), str(REPO_ROOT / "tools/posgen/relabel_with_syzygy.py"),
...
def main() -> int:
    ...
    with locked(lock_path):
        ...
        print(
            f"label_mode=syzygy-tb output={args.output} "
