...
- Candidate: `native-4.15.0-rc1`; parent: `native-4.14.0-rc4`.
- Continue the successful 128-superbatch factorised regimen unchanged on the
  next pylon slice.
- Keep 16 input buckets, 8 output buckets, LR 0.0001, and WDL 0.05.
