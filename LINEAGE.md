...
| enyo-5.6.0-rc1 | pwa-llm | enyo-5.5.0-rc1 | sixth full dose with the selected regimen | accepted | e12a6c3c797b0de44e3024c3ee20583e4af5136f3cebb1d14d270823c3a27b57 | pending | +11.6 / 10.8 | -204.9 / 8.2 | 4000 | Passed parent SPRT with LLR 1.56/2.20 and LOS 98.2%; sibling selection pending rc2. |
| enyo-5.6.0-rc2 | pwa-5090 | enyo-5.5.0-rc1 | raise initial LR from 0.0010 to 0.0020 | reserved | — | — | — | — | 0 | Same architecture, corpus, dose, WDL, and final LR; `continue_from` rc1. |
