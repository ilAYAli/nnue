...
| enyo-5.7.0-rc1 | pwa-llm | enyo-5.6.0-rc2 | seventh full dose with the selected initial LR 0.0020 regimen | training | — | — | — | — | 0 | Same architecture, corpus, dose, WDL, and optimizer; `continue_from` rc2. |
