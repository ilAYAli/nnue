...
| enyo-5.1.0-rc1 | pwa-llm | enyo-5.0.0-rc1 | second full dose on the same interleaved corpus | reserved | — | — | — | — | 0 | Same architecture, data, WDL, and optimizer; `continue_from` root. |
