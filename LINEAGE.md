...
| enyo-5.6.0-rc1 | pwa-llm | enyo-5.5.0-rc1 | sixth full dose with the selected regimen | reserved | — | — | — | — | 0 | Same architecture, corpus, WDL, and optimizer; `continue_from` rc1. |
