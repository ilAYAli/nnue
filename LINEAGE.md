...
Current selected parent: `enyo-7.5.0-rc27` (+3.7 ±6.2 vs `enyo-7.5.0-rc21`,
LLR 1.28/2.20 (58%) at 4,000/4,000 games, inconclusive — promoted on SF
tie-break (-123.5 ±6.9 vs -125.4 ±6.8 for rc21); next full dose off rc21,
same recipe (Pylon binpack, sb=768, wdl=0.025, lr=0.004). Between rc21 and
rc27, five straight rejections (rc22-rc26): two single-variable
hyperparameter probes (lr 0.004→0.005 on rc24, wdl 0.025→0.015 on rc25) both
underperformed and were reverted; the rest were plain data-slice attempts
that lost the SF tie-break. rc21 itself: +11.5 ±7.8 vs `enyo-7.5.0-rc17`,
LLR 2.41/2.20, clean H1 win.
