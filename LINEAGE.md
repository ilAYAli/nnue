...
| enyo-5.2.0-rc1 | pwa-llm | enyo-5.1.0-rc2 | second full dose on the winning self-play-1.2 corpus | reserved | — | — | — | — | 0 | Same architecture, WDL, data, and optimizer; `continue_from` rc2. |
