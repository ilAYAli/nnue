...
| enyo-5.3.0-rc1 | pwa-llm | enyo-5.2.0-rc1 | third full dose with the selected WDL 0.05 regimen | reserved | — | — | — | — | 0 | Same architecture, corpus, and optimizer; `continue_from` rc1. |
| enyo-5.3.0-rc2 | pwa-5090 | enyo-5.2.0-rc1 | raise final LR from 0.000005 to 0.000010 | reserved | — | — | — | — | 0 | Same architecture, corpus, dose, and WDL; `continue_from` rc1. |
