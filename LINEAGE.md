...
| enyo-5.8.0-rc1 | pwa-llm | enyo-5.7.0-rc2 | eighth full dose with the selected initial LR 0.0030 regimen | training | — | — | — | — | 0 | Same architecture, corpus, dose, WDL, and optimizer; `continue_from` rc2. |
