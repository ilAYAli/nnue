...
| enyo-5.7.0-rc1 | pwa-llm | enyo-5.6.0-rc2 | seventh full dose with the selected initial LR 0.0020 regimen | accepted | 255d04a3759ed354ff8d71a7e7c8b328bfad09801202e8911b99144d292a5d29 | pending | +12.3 / 9.9 | -196.8 / 8.1 | 4000 | Passed parent SPRT with LOS 99.2%; sibling selection pending rc2. |
| enyo-5.7.0-rc2 | pwa-5090 | enyo-5.6.0-rc2 | raise initial LR from 0.0020 to 0.0030 | training | — | — | — | — | 0 | Same architecture, corpus, dose, WDL, and final LR; `continue_from` rc2. |
