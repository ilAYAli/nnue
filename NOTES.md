...
These are longer explanations and personal notes. They are intentionally less
concise than `README.md` and `NNUE.md`.

Use:

```text
README.md  build.py workflow and how to create a candidate
NNUE.md    concise native Enyo NNUE runtime design
NOTES.md   vocabulary, examples, and longer explanations
```
